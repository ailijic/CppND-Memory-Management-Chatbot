...
template <typename T>
void ChatLogic::AddAllTokensToElement(std::string tokenID,
                                      tokenlist& tokens,
                                      T& element) {
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
  ...
  // create instance of chatbot
  ChatBot stack_chat("../images/chatbot.png");
  stack_chat.SetChatLogicHandle(this);

  // add chatbot to graph root node
  stack_chat.SetRootNode(rootNode);
  rootNode->MoveChatbotHere(stack_chat);
